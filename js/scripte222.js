!function(a) {
    "use strict";
    var e = a(window), i = a("body"), l = a(".navbar");
    function t() {
        return e.width();
    }
    ...
    a('a.menu-link[href*="#"]:not([href="#"])').on("click", function() {
        if (location.pathname.replace(/^\//, "") === this.pathname.replace(/^\//, "") && location.hostname === this.hostname) {
            var e = a(this.hash), i = !!this.hash.slice(1) && a("[name=" + this.hash.slice(1) + "]"), t = s >= 992 ? l.height() - 1 : 0;
            if ((e = e.length ? e : i).length) return a("html, body").animate({
                scrollTop: e.offset().top - t
            }, 1e3, "easeInOutExpo"), !1;
        }
    });
    var d = window.location.href, o = d.split("#"), m = a(".nav li a");
    m.length > 0 && m.each(function() {
        d === this.href && "" !== o[1] && a(this).closest("li").addClass("active").parent().closest("li").addClass("active");
    });
    var c = a(".dropdown"), h = a(".dropdown-toggle");
    c.length > 0 && (c.on("mouseover", function() {
        ...
        if (e.width() < 991) return a(this).parent().children(".dropdown-menu").fadeToggle(400), 
        a(this).parent().toggleClass("open"), !1;
    })), e.on("resize", function() {
        a(".navbar-collapse").removeClass("in"), c.parent().children(".dropdown-menu").fadeOut("400");
    });
    var p = a(".navbar-toggler"), v = a(".is-transparent");
    ...
    g.length > 0 && g.select2(), a(".menu-link").on("click", function() {
        ...
        v.is(e.target) || 0 !== v.has(e.target).length || (a(".navbar-collapse").collapse("hide"), 
    ...
    if (z.length > 0) {
        ...
        z.each(function() {
            var e = a(this), i = e.data("items") ? e.data("items") : 4, l = i >= 3 ? 2 : i, t = l >= 2 ? 1 : l, s = e.data("delay") ? e.data("delay") : 6e3, n = !!e.data("auto"), r = !!e.data("loop"), d = !!e.data("dots"), o = !!e.data("navs"), m = !!e.data("center"), c = e.data("margin") ? e.data("margin") : 30;
    ...
    P.length > 0 && P.each(function() {
        var e = a(this), i = e.attr("data-date");
    ...
    S.length > 0 && S.each(function() {
        var e = a(this), i = e.parent(), l = e.data("overlay"), t = e.children("img").attr("src"), s = void 0 !== l && "" !== l && l.split("-");
        void 0 !== t && "" !== t && (i.hasClass("has-bg-image") || i.addClass("has-bg-image"), 
        "" !== s && "dark" === s[0] && (i.hasClass("light") || i.addClass("light")), e.css("background-image", 'url("' + t + '")').addClass("bg-image-loaded"));
    });
    ...
    var H = a("#contact-form"), V = a("#subscribe-form");
    if (H.length > 0 || V.length > 0) {
        if (!a().validate || !a().ajaxSubmit) return console.log("contactForm: jQuery Form or Form Validate not Defined."), 
        !0;
        if (H.length > 0) {
            var _ = H.find("select.required"), B = H.find(".form-results");
            H.validate({
                ...
                submitHandler: function(e) {
                    B.slideUp(400), a(e).ajaxSubmit({
                        ...
                        success: function(i) {
                            ...
                            B.removeClass("alert-danger alert-success").addClass("alert " + l).html(i.message).slideDown(400), 
            ...
            V.validate({
                ...
                submitHandler: function(e) {
                    U.slideUp(400), a(e).ajaxSubmit({
                        ...
                        success: function(i) {
                            var l = "error" === i.result ? "alert-danger" : "alert-success";
                            U.removeClass("alert-danger alert-success").addClass("alert " + l).html(i.message).slideDown(400), 
    ...
    var O = "../ico/images/", F = "RTL Mode", M = "./rtl/index.html", E = "../ico/", R = "../ico-user/";
    ...
    a().waypoint && K.length > 0 && e.on("load", function() {
        K.each(function() {
            var e = a(this), i = e.data("animate"), l = e.data("duration"), t = e.data("delay");
            e.waypoint(function() {
                e.addClass("animated " + i).css("visibility", "visible"), l && e.css("animation-duration", l + "s"), 
    ...
    var N = a("#particles-js"), W = "#2b56f5", Z = "#00c0fa";
